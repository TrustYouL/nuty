...
extern zipFile ZEXPORT zipOpen2_65(const void *path, int append, const char **globalcomment,
...
extern zipFile ZEXPORT zipOpen33(const char *path, int append, uint64_t disk_size, const char **globalcomment,
    zlib_filefunc_def *pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
...
{
    return zipOpen33((const void*)path, append, 0, NULL, NULL);
}

extern zipFile ZEXPORT zipOpen65(const void *path, int append)
{
    return zipOpen33(path, append, 0, NULL, NULL);
}

extern int ZEXPORT zipOpenNewFileInZip4_65(zipFile file, const char *filename, const zip_fileinfo *zipfi,
...
//}
extern int ZEXPORT zipOpenNewFileInZip44(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
{
    return zipOpenNewFileInZip4_65(file, filename, zipfi, extrafield_local, size_extrafield_local,
...
extern int ZEXPORT zipOpenNewFileInZip3_65(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
    uint16_t size_extrafield_global, const char *comment, uint16_t method, int level, int raw, int windowBits,
...
extern int ZEXPORT zipOpenNewFileInZip2_65(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zipOpenNewFileInZip65(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zipCloseFileInZipRaw65(zipFile file, uint64_t uncompressed_size, uint32_t crc32)
{
    zip64_internal *zi = NULL;
...
{
    return zipCloseFileInZipRaw65(file, uncompressed_size, crc32);
}
