...
@interface TOPGridDocDetailCollectionViewCell()

@end
@implementation TOPGridDocDetailCollectionViewCell
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_showBackBtn addTarget:self action:@selector(clickShowBackBtn:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [_noteBtn addTarget:self action:@selector(clickNoteBtn:) forControlEvents:UIControlEventTouchUpInside];
        
        _ocrBtn = [UIButton new];
        [_ocrBtn setImage:[UIImage imageNamed:@"top_nextocr"] forState:UIControlStateNormal];
        [_ocrBtn addTarget:self action:@selector(clickOCRBtn:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)clickShowBackBtn:(UIButton *)sender{
...
- (void)clickNoteBtn:(UIButton *)sender{
...
- (void)clickOCRBtn:(UIButton *)sender{
