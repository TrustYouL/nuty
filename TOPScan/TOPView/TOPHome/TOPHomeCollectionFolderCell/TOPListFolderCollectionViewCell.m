...
@interface TOPListFolderCollectionViewCell()
...
@end
@implementation TOPListFolderCollectionViewCell
...
- (UIImageView*)imgV{
    if (!_imgV) {
        _imgV = [[UIImageView alloc] initWithFrame:CGRectMake((15), (10), (25),(20))];
...
- (UILabel*)numLabel{
    if (!_numLabel) {
        _numLabel = [[UILabel alloc] initWithFrame:CGRectMake( self.frame.size.width - (30) , (10), (14), (14))];
...
- (UIView*)lineView{
    if (!_lineView) {
        _lineView = [[UIView alloc] initWithFrame:CGRectMake(0, (43),TOPScreenWidth,0.5)];
...
- (void)setModel:(DocumentModel *)model{
    ...
    if (numSize.width > (14)) {
        self.numLabel.frame = CGRectMake(self.frame.size.width - (10) - numSize.width, CGRectGetMaxY(self.titleLabel.frame)+ (5), numSize.width, (14));
    }
}
