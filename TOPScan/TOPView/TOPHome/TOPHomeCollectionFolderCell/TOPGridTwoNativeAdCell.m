...
@implementation TOPGridTwoNativeAdCell
...
- (void)top_setViewFream{
    ...
    [_bodyLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.equalTo(_nativeAdView).offset(10);
        make.trailing.equalTo(_nativeAdView).offset(-10);
        make.top.equalTo(_medieaView.mas_bottom).offset(10);
