...
@implementation TOPKeychainManager
+ (TOPKeychainManager *)defaultManager{
    static TOPKeychainManager * topKeychainManager = nil;
    if (topKeychainManager == nil) {
        topKeychainManager = [[TOPKeychainManager alloc]init];
    }
    return topKeychainManager;
}
