...
@implementation TOPGPUImageWhiteBlackFilter
...
- (id)init;
{
    ...
    GPUImageBoxBlurFilter * brightFilter = [[GPUImageBoxBlurFilter alloc] init];
    [self addFilter:brightFilter];
    ...
    [luminanceFilter addTarget:brightFilter];
    [brightFilter addTarget:adaptiveThresholdFilter];
